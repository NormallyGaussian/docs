...
For detailed documentation of all features and configuration options, head to the @[`ChatParallelWeb`] API reference or https://docs.parallel.ai/chat-api/chat-quickstart
